...
- (void)customTabBarView
{
    ...
    for (int i = 0; i< _tabbarArray.count;i++ ) {
        ...
        if (button_type && button_type.intValue == 3) {
            
            button.frame = CGRectMake(_tabBarBG.width/_tabbarArray.count * i, -30, _tabBarBG.width/_tabbarArray.count, _tabBarBG.height + 30);
            [button setImage:kIMG(@"post_normal") forState:UIControlStateNormal];
